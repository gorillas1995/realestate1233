...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="fixed top-6 right-6 z-[100] bg-white/95 backdrop-blur-md border border-border rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2 group cursor-pointer"
